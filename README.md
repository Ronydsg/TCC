# TCC - GETOLDER
O dispositivo trata-se de uma pulseira capaz de detectar quedas e emitir um sinal de alerta a um aplicativo também desenvolvido exclusivamente para isso.
